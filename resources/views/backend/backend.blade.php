...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="{{ asset('/backend/vendor/fontawesome/css/font-awesome.min.css') }}">
		<link rel="stylesheet" href="{{ asset('/backend/vendor/themify-icons/themify-icons.min.css') }}">
		<link href="{{ asset('/backend/vendor/animate.css/animate.min.css') }}" rel="stylesheet" media="screen">
		<link href="{{ asset('/backend/vendor/perfect-scrollbar/perfect-scrollbar.min.css') }}" rel="stylesheet" media="screen">
		<link href="{{ asset('/backend/vendor/switchery/switchery.min.css') }}" rel="stylesheet" media="screen">
		<!-- end: MAIN CSS -->
		<!-- start: CLIP-TWO CSS -->
		...
		<link rel="stylesheet" href="{{ asset('/backend/assets/css/themes/theme-1.css') }}" id="skin_colorTT" />
		<!-- end: CLIP-TWO CSS -->
	...
	<body>
		<div id="app">
			...
			<div class="app-content">
				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brandFF" href="#">
							<img src="{{ asset('/backend/assets/images/logo.png') }}" alt="ELN"/>
						</a>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
										...
										<div class="drop-down-wrapper ps-container">
											<div class="list-group no-margin">
												<a class="media list-group-item" href="">
													<img class="img-circle" alt="..." src="{{ asset('/backend/assets/images/avatar-1.jpg') }}">
							...
							<li class="dropdown current-user">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<img src="{{ asset('/backend/assets/images/avatar-1.jpg') }}" alt="Peter"> <span class="username">Peter <i class="ti-angle-down"></i></i></span>
								</a>
			...
			<footer>
				<div class="footer-inner">
					<div class="pull-left">
						&copy; <span class="current-year"></span> <span class="text-bold text-uppercase">Hectacon</span>. <span>All rights reserved</span>
					</div>
		...
		<script src="{{ asset('/backend/vendor/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
		<script src="{{ asset('/backend/vendor/switchery/switchery.min.js') }}"></script>
